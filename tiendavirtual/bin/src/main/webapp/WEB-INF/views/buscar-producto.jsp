...
<body>
				...
				<ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll"
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							...
							<%
							if (user.getUsername().equals("administrador") && user.getPassword().equals("administrador")) {
							%>
	...
	<div class="container mt-2" style="min-height: 680px">
		...
		<div class='row'>
			...
			<%
			List<Product> busqueda_productos = (List<Product>) request.getAttribute("busqueda_productos");

			if (busqueda_productos.isEmpty()) {
			%>
			<p>No se ha encontrado ningún producto</p>
			<%
			} else {

			for (Product producto : busqueda_productos) {
			%>
