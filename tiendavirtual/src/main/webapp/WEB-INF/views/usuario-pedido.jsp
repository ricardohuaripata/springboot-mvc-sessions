...
<body>
	...
	List<ProductoCarrito> orderProducts = (List<ProductoCarrito>) request.getAttribute("orderProducts");
	...
	<div class="container" style="margin-top: 20px; min-height: 680px">
		...
		<div class='row'>
			<%
			for (ProductoCarrito producto : orderProducts) {
			%>
			<div class='col-sm-4'>
				<div class="card">
					...
					<div class="card-footer">
						...
						<p>
							Total:
							<%=String.format("%.2f", producto.getCantidad() * producto.getPrice())%>€
						</p>
					</div>
				</div>
			</div>
		...
		<p>
			Dirección:
			<%=pedido.getDireccion()%></p>

		<p>
			Provincia:
			<%=pedido.getProvincia()%></p>

		<p>
			Municipio:
			<%=pedido.getMunicipio()%></p>

		<p>
			Código postal:
			<%=pedido.getCodigopostal()%></p>

		<p>
			Teléfono de contacto:
			<%=pedido.getTelefono()%></p>
